...
public class CandidateService {
	...
	public void register() {
		...
		candidate.setSlcStatus(slcStatusRepo.findBySlcStatusId(1));

		candidate.setSelectionStage(selectionStage);

		candidate.setCandidateName("");
		candidate.setAptitudeFlag(0);
		candidate.setInsertDate(new Date());
	 ...
	 */
	public void update(List<Candidate> candidates) {
